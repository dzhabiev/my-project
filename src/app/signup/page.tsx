      ...
      >
        <div className="mx-auto w-full max-w-md">
          <motion.div
            ...
            className="rounded-3xl border border-gray-200 bg-white p-8 shadow-lg text-center"
          >
            <div className="mb-4 flex justify-center">
              <div className="rounded-full bg-gradient-to-r from-[#3B82F6] to-[#06B6D4] p-3">
            ...
            <Link
              href="/login"
              className="inline-block rounded-full bg-gradient-to-r from-[#3B82F6] to-[#06B6D4] px-6 py-3 text-base font-bold text-white shadow-lg transition-all hover:shadow-xl"
            >
              Go to Login
            </Link>
          </motion.div>
      ...
      <div className="mx-auto w-full max-w-md">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Start creating amazing stickers</p>
          </div>
